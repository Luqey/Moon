...
public class DamageLabel : MonoBehaviour
{
    ...
    private float _randomAngle; // angle in degrees
    ...
    // Randomize sideways drift ONCE here
    ...
    _highPointOffsetBasedOnDirection.x *= randomX * xScale;
    _dropPointOffsetBasedOnDirection.x *= randomX * xScale;
